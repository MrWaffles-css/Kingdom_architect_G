-- Final update for reset_world to ensure all technologies are reset
-- This includes military tech and new spy report tech
...
BEGIN
    ...
    UPDATE user_stats SET
        ...
        -- Tech Tree Research (The missing ones)
        research_attack = 0,
        research_defense = 0,
        research_sentry = 0,
        research_spy = 0,
    ...
    RAISE NOTICE 'World has been reset successfully! All stats, items, and research cleared.';
END;
$$;
