-- Fix Reset World Stats
-- Ensures that calculated strength columns (attack, defense, spy, sentry) and weapon aggregates are also reset to 0.
...
BEGIN
    ...
    UPDATE user_stats SET
        ...
        -- Reset Aggregate Weapon Counts (NEW)
        attack_weapons = 0,
        defense_weapons = 0,
        spy_weapons = 0,
        sentry_weapons = 0,
        
        -- Reset Calculated Strengths (NEW)
        attack = 0,
        defense = 0,
        spy = 0,
        sentry = 0,
