-- Fix Citizen Generation Rate
-- Updates the formula to kingdom_level * 1 (was * 10) to match gameConfig and user expectation.
...
BEGIN
    ...
    -- A. Citizens (1 * Level) -- FIXED: Changed from 10 to 1
