-- Fix Turn Generation Logic
-- Explicitly aligns the server-side calculation with the Library description.
-- "Level 1" = 1 turn per minute. "Level 0" = 0 turns per minute.
...
BEGIN
    ...
    -- =====================================================
    -- Formula: research_turns_per_min (e.g. 1 at level 1)
    -- OLD: (1 + COALESCE(v_stats.research_turns_per_min, 0)) * v_minutes_passed;
