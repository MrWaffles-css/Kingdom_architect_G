-- Fix Spy and Attack logic for fake Clippy ID
...
BEGIN
    ...
    IF target_id = '00000000-0000-0000-0000-000000000000'::uuid THEN
        ...
        -- KEY FIX: Do NOT insert into spy_reports for fake ID because it violates FK constraint on auth.users
        -- We just return success locally.
