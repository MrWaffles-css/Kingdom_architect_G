-- Fix Turn Generation Logic to be Linear (Base 2 + Level)
-- Matches User Request: Level 1 = 1 turn bonus (Total 3), Level 2 = 2 turns bonus (Total 4)
...
BEGIN
    ...
    -- =====================================================
    -- TURN GENERATION (UPDATED to Match Request)
    -- =====================================================
    -- Base 2 + Level
    -- Level 0 = 2 turns
    -- Level 1 = 3 turns (+1 bonus)
    -- Level 2 = 4 turns (+2 bonus)
    ...
    BEGIN
        ...
        v_turns_per_min := 2 + v_res_level; -- Simple Linear Logic
