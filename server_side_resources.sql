-- Server-side Resource Generation with pg_cron
-- Run this in Supabase SQL Editor

-- 1. Enable pg_cron extension
CREATE EXTENSION IF NOT EXISTS pg_cron;

-- 2. Create the Game Tick Function
-- This function processes one minute of resource generation for ALL users
...
BEGIN
    ...
    FOR v_user IN SELECT * FROM public.user_stats LOOP
        ...
        -- Formula: 1 per kingdom level
        v_citizen_gain := v_user.kingdom_level * 1;
