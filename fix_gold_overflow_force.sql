...
-- Ensures that ALL stolen gold goes into the Vault, even if it exceeds capacity.
-- This effectively disables passive income until the vault is below capacity again.
...
BEGIN
    ...
    IF v_attacker_stats.attack > v_defender_stats.defense THEN
        ...
        -- === UPDATE ATTACKER ===
        -- ALL stolen gold goes to Vault, regardless of capacity.
        UPDATE public.user_stats
