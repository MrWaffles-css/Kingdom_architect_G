-- Add Technology Research System (Attack, Defense, Spy, Sentry)
-- Run this in Supabase SQL Editor

-- 1. Add research columns to user_stats (if not exists)
...
-- 2. Helper: Get Tech Multiplier based on Level
-- Returns the multiplier (e.g. 1.1 for +10%)
...
BEGIN
    ...
    -- Table based on User Request (+% rounded to nearest 10)
    CASE p_level
        WHEN 0 THEN RETURN 1.0;
        WHEN 1 THEN RETURN 1.10; -- +10%
        WHEN 2 THEN RETURN 1.10; -- +10%
        WHEN 3 THEN RETURN 1.20; -- +20%
        WHEN 4 THEN RETURN 1.30; -- +30%
        WHEN 5 THEN RETURN 1.30; -- +30%
        WHEN 6 THEN RETURN 1.40; -- +40%
        WHEN 7 THEN RETURN 1.50; -- +50%
        WHEN 8 THEN RETURN 1.50; -- +50%
        WHEN 9 THEN RETURN 1.60; -- +60%
        WHEN 10 THEN RETURN 1.70; -- +70%
        WHEN 11 THEN RETURN 1.80; -- +80%
        WHEN 12 THEN RETURN 1.80; -- +80%
        WHEN 13 THEN RETURN 1.90; -- +90%
        WHEN 14 THEN RETURN 2.00; -- +100%
        WHEN 15 THEN RETURN 2.10; -- +110%
        WHEN 16 THEN RETURN 2.20; -- +120%
        WHEN 17 THEN RETURN 2.30; -- +130%
        WHEN 18 THEN RETURN 2.50; -- +150% (Jump)
        WHEN 19 THEN RETURN 2.60;
        WHEN 20 THEN RETURN 2.70;
        WHEN 21 THEN RETURN 2.80;
        WHEN 22 THEN RETURN 3.00; -- +200%
        WHEN 23 THEN RETURN 3.10;
        WHEN 24 THEN RETURN 3.30; -- +230%
        WHEN 25 THEN RETURN 3.40;
        WHEN 26 THEN RETURN 3.60;
        WHEN 27 THEN RETURN 3.80;
        WHEN 28 THEN RETURN 4.00; -- +300%
        WHEN 29 THEN RETURN 4.20;
        WHEN 30 THEN RETURN 4.40;
        WHEN 31 THEN RETURN 4.60;
        WHEN 32 THEN RETURN 4.80;
        WHEN 33 THEN RETURN 5.00; -- +400%
        WHEN 34 THEN RETURN 5.30;
        WHEN 35 THEN RETURN 5.60;
        WHEN 36 THEN RETURN 5.80;
        WHEN 37 THEN RETURN 6.10; -- +510%
        WHEN 38 THEN RETURN 6.40;
        WHEN 39 THEN RETURN 6.70;
        WHEN 40 THEN RETURN 7.10;
        WHEN 41 THEN RETURN 7.40;
        WHEN 42 THEN RETURN 7.80;
        WHEN 43 THEN RETURN 8.20; -- +720%
        WHEN 44 THEN RETURN 8.60;
        WHEN 45 THEN RETURN 9.00; -- +800%
        WHEN 46 THEN RETURN 9.50;
        WHEN 47 THEN RETURN 10.00; -- +900%
        WHEN 48 THEN RETURN 10.40;
        WHEN 49 THEN RETURN 11.00; -- +1000%
        WHEN 50 THEN RETURN 11.50;
        WHEN 51 THEN RETURN 12.10;
        WHEN 52 THEN RETURN 12.70;
        WHEN 53 THEN RETURN 13.30;
        WHEN 54 THEN RETURN 14.00; -- +1300%
        WHEN 55 THEN RETURN 14.70;
        WHEN 56 THEN RETURN 15.40;
        WHEN 57 THEN RETURN 16.20; -- +1520%
        WHEN 58 THEN RETURN 17.00; -- +1600%
        WHEN 59 THEN RETURN 17.80;
        WHEN 60 THEN RETURN 18.70;
        WHEN 61 THEN RETURN 19.70;
        WHEN 62 THEN RETURN 20.60;
        WHEN 63 THEN RETURN 21.70; -- +2070%
        ELSE RETURN 21.70; -- Cap at max
    END CASE;
END;
$$;

-- 3. Helper: Get Tech Cost based on Level (Next Level Cost)
...
AS $$
BEGIN
    -- Cost for Next Level (Level 0 -> 1 is index 0 in usage, but logical level 1 cost)
    -- This function returns the cost to upgrade TO (p_current_level + 1)
    CASE p_current_level
        ...
        ELSE RETURN 999999999; -- Max Level
    END CASE;
END;
$$;
...
-- Applies the research multipliers as the final step
...
DECLARE
    ...
    v_mult_sentry FLOAT;
BEGIN
    -- Get current stats & research levels
    SELECT 
    ...
    -- Calculate Raw Strengths (Soldiers + Weapons)
    ...
    -- Update user_stats with FINAL values
    UPDATE user_stats
    SET 
