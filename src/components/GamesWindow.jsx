...
export default function GamesWindow({ onNavigate, initialGame, session, stats }) {
    ...
    if (selectedGame === 'snake') {
        return (
            <div className="h-full flex flex-col">
                ...
                <Snake session={session} stats={stats} />
            </div>
        );
    }
    ...
    return (
        <div className="bg-white p-4 h-full">
            ...
            <div className="grid grid-cols-4 gap-4">
                ...
                {/* Solitaire - Hidden temporarily due to bugs
                <div
                    className="flex flex-col items-center justify-center p-4 hover:bg-blue-100 cursor-pointer border border-transparent hover:border-blue-300 rounded"
                ...
                */}
                ...
                >
                    <div className="text-4xl mb-2">🐍</div>
                    <span className="text-sm font-bold">Snake</span>
                </div>
