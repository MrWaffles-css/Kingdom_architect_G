...
-- =====================================================
-- This script moves resource generation (gold, XP, turns, citizens, vault)
-- from client-side JavaScript to server-side SQL for better performance
...
BEGIN
    ...
    -- Level 1: 2g, Level 2: 3g, ..., Level 25: 26g
    ...
    -- TURN GENERATION
    -- =====================================================
    -- Formula: (1 + research_turns_per_min) turns per minute
    v_turn_gain := (1 + COALESCE(v_stats.research_turns_per_min, 0)) * v_minutes_passed;
